...
<template>
  <section v-if="state.section" class="continue-search">
    <div>{{ state.section.sectionData.searchParams.query }} 숙소 검색 계속하기 <span>{{ state.section.sectionData.items[0].structuredContent.primaryLine[0].body }}</span><span> 게스트 1명</span><button class="right" href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M247.1 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L179.2 256 41.9 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z"/></svg></button>
    </div>
    <div>
